...
"""
Playing around with values to debug
"""
import numpy as np
#############################################
units = 2
quantized_kernel = np.array([[0.25, -0.21875, 0.4375, 0.4375, 0.875, -0.875], [0.875, 0, 0, 0, 0, 0]])
quantized_recurrent = np.array([[0.875, 0, 0, 0, 0, 0], [0.875, 0, 0, 0, 0, 0]])
input_bias = np.array([0.25, -0.25, 0.5, -0.5, 1, -1])
inputs = np.array([[1, -1]])
h_tm1 = np.array([[0, 0]])
#####
#
