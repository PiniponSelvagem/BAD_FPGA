class ModelConfig:
    ...
    ##################################################
    name = "model_quant_411_qconvbnorm_smallDebug" # model file name
    folder = "model_quantized_debug"          # model saved location
    ...
    def customModel():
        ...
        #
        spec = keras.Input(shape=[8, 2, 1], dtype=np.float32)
        #
        x = QConv2DBatchnorm(
