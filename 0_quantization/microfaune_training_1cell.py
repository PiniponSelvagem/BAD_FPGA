...
datasets_dir = '/mnt/e/Rodrigo/ISEL/2_Mestrado/2-ANO_1-sem/TFM/datasets'
save_dir = '/mnt/e/Rodrigo/ISEL/2_Mestrado/2-ANO_1-sem/TFM/BAD_FPGA/0_quantization/model'
model_name = 'microfaune_1cell'
plots_dir = "plots"
epochs = 100
steps_per_epoch = 100
training_dataset_percentage = 1.0
#model_original, dual_model_original = qmodel.MicrofauneAI.model()
microfaune = MicrofauneAI()
model, dual_model = microfaune.modelOriginal()
"""
...
X0 = keep_percentage_of_array(X0, training_dataset_percentage)
Y0 = keep_percentage_of_array(Y0, training_dataset_percentage)
uids0 = keep_percentage_of_array(uids0, training_dataset_percentage)

X1 = keep_percentage_of_array(X1, training_dataset_percentage)
Y1 = keep_percentage_of_array(Y1, training_dataset_percentage)
uids1 = keep_percentage_of_array(uids1, training_dataset_percentage)
#################################################
