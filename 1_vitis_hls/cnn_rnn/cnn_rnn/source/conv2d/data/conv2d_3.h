...
#define C2D_3__RAW_IN_LINES     BNORM_2__RAW_OUT_LINES
#define C2D_3__RAW_IN_COLS      BNORM_2__RAW_OUT_COLS
...
*/
conv_t kernel_3[CHANNELS][FILTERS][C2D_KERNEL_LINES][C2D_KERNEL_COLS];
