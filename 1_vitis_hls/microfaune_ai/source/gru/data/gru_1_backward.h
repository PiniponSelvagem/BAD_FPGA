...
*/
gru_t kernel_gru1_b[GRU_1__KERNEL_LINES][GRU_SPLIT][GRU_1__KERNEL_COLS];
/**
 * @brief This was taken from "model_json__channel_last/dump_weights_bias.json". (Channels last)
*/
gru_t recurrent_kernel_gru1_b[GRU_1__KERNEL_R_LINES][GRU_SPLIT][GRU_1__KERNEL_R_COLS];
